        ...
        <div className='info-main-wrapper'>
            ...
            <section className='info-top-cont'>
                    ...
                    <div className="guest-info">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className='form-input name'>
                                ...
                                <input type="text" name="middlename" onChange={handleChange} placeholder='Enter the middle name' />
                                <input type="text" name="lastname" onChange={handleChange} placeholder='Enter the last name' />
                            </div>
                            ...
                            <div className='form-input'>
                                <label>Email</label>
                                <input name="email" type="email" onChange={handleChange} placeholder='Select the email' />
                            </div>
                            <div className='form-input'>
                                <label>Number</label>
                                <input name="phone" type="number" onChange={handleChange} placeholder='Enter phone number' />
                            </div>
                            <div className='form-input'>
                                <label>Address</label>
                                <textarea name="address" id="" onChange={handleChange} placeholder='Select the address' cols="30" rows="10"></textarea>
                            </div>
                            <hr />
                ...
                <div className="right">
                    <div className='title'>
                        <h4>Summary</h4>
                        <p>1 night <span>staring from </span>Sat 1 Jan, 2022</p>
                    </div>
                    <div className='detail'>
                        ...
                        <div className='detail-2'>
                            <p>4 Bed Female Dorm x 2</p>
                            <p>Rs 1,998 <span> x  1 night</span></p>
                        </div>
                        <div className='detail-3'>
                            <p>Rs 1998</p>
                        </div>
                    </div>
                    <div className='tax'><h5>Tax</h5> <p>Rs 0</p></div>
                    <div className='total'><h5>Total (tax incl.)</h5><p>Rs 1,998</p></div>
                    <div className='pay'><h5>Payable Now</h5><p>Rs 1,998</p></div>
                    <div className='agree'>
